...
ipc.on('cut_layout', function (event, direction) {
        layout.setCutter({active: true, direction: direction});
        cut_divisions = true;
})
...
$(document).ready(function () {
    ...
    partitionLayout.import(layout_base);
