...
Coloque o vistechlib ao lado da pasta deste projeto e digite o seguinte comando no diretório local deste projeto:

```bash
npm i --no-save ../@labvis-ufpa/vistechlib
```


---- TODO: remover documentação do Electron.
