...
SVG.FX = SVG.invent({
  ...
  // Add class methods
, extend: {
    // Add animation parameters and test animation
          ...
          fx.render = function() {
            ...
            if (fx.situation.play === true) {
              ...
              var time = new Date().getTime()
                , pos = time > fx.situation.finish ? 1 : (time - fx.situation.test) / d
