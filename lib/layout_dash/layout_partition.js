           ...
           // .off()
            .mousemove((e) => {
              ...
              if (this.layout.cutter_on && partition && this === partition){
                  ...
                  console.log('height',partition,partition.height);
                  console.log('direction',this.layout.placeholder_cutter);
                  let dif = ph.p_dir === 'column'? (location*2)/partition.height:(location*2)/partition.width;
                  console.log('target test:', e.target);
                  console.log("dif",dif);

                  console.log("location:"+location+" height: "+ partition.height,'result',location/partition.height)
                  ph.setLocation(location)
                  ...
                  if(partition.isLeaf){
                    console.log('dif',dif);
                    partition.addChild(new Partition( this.layout,{proportion:1}));
                  }
